library(dplyr)
rm(list = ls())
base.dir <- "C:\\Users\\ale\\Desktop\\scriptR\\"
setwd(base.dir)
...
designite.ds3 = extract_data_designite(designite.data[1])
designite.ds4 = extract_data_designite(designite.data[2])
designite.ds5 = extract_data_designite(designite.data[1])
